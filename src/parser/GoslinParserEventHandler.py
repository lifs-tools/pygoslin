...
from domain.LipidCategory import LipidCategory
...
class GoslinParserEventHandler(BaseParserEventHandler):
    ...
    def __init__(self):
        ...
        self.registered_events["pl_pre_event"] = self.set_gp
        self.registered_events["sl_pre_event"] = self.set_sp
        self.registered_events["cholesterol_pre_event"] = self.set_st
        self.registered_events["mediatorc_pre_event"] = self.set_fa
    
    

    def reset_lipid(self, node):
        self.category = LipidCategory.UNDEFINED
    ...
    def set_gl(self, node):
        self.category = LipidCategory.GL
        

    def set_gp(self, node):
        self.category = LipidCategory.GP
        

    def set_sp(self, node):
        self.category = LipidCategory.SP
        

    def set_st(self, node):
        self.category = LipidCategory.ST
        

    def set_fa(self, node):
        self.category = LipidCategory.FA
