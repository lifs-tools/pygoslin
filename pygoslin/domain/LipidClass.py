...
class LipidClass(Enum):
    ...
    PIP = (LipidCategory.GP, "Glycerophosphoinositol monophosphates [GP07]", "PIP", "PIP[3']", "PIP[4']", "PIP[5']")
    PIP2 = (LipidCategory.GP, "Glycerophosphoinositol bisphosphates [GP08]", "PIP2", "PIP2[3',4']", "PIP2[3',5']", "PIP2[4',5']")
    PIP3 = (LipidCategory.GP, "Glycerophosphoinositol trisphosphates [GP09]", "PIP3", "PIP3[3',4',5']")
