...
class GoslinParserEventHandler(BaseParserEventHandler):
    ...
    def __init__(self):
        ...
        self.registered_events["hg_pip_m_pre_event"] = self.set_head_group_name
        self.registered_events["hg_pip_d_pre_event"] = self.set_head_group_name
        self.registered_events["hg_pip_t_pre_event"] = self.set_head_group_name
